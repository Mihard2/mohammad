<?php
if (!class_exists('Inforward_Testimonials_Config')) {

	class Inforward_Testimonials_Config extends Inforward_Functionality {
		...
		public function init() {
			...
			$args = array(
				'labels' => $this->getLabels(
					__('Testimonial', 'inforward_app_textdomain'),
					__('Testimonials', 'inforward_app_textdomain')
				),
				'public' => true,
				'archive' => true,
