...
<div id="wpbe_tools_panel">
    ...
    <div class="wpbe_tools_panel_wrapper">
        ...
        <span>
            <!-- next, todo -->
            <?php //echo WPBE_HELPER::draw_advanced_switcher(0, 'wpbe_show_variations', '', array('true' => esc_html('variations', 'bulk-editor'), 'false' => esc_html('comments', 'bulk-editor')), array('true' => 1, 'false' => 0), 'js_check_wpbe_show_variations', 'wpbe_show_variations'); ?>
            <?php //echo WPBE_HELPER::draw_tooltip(esc_html('Bulk editing of the parent posts will be ignored!', 'bulk-editor')) ?>
        </span>&nbsp;
