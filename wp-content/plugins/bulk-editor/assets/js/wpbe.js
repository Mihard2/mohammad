...
(function ($) {
    ...
    jQuery(function () {
        ...
        jQuery('.wpbe_drag_and_drope').life('click', function () {
            return false;
        });
        ...
        jQuery('.wpbe_select_image').life('click', function ()
        {
...
function wpbe_init_advanced_panel() {
    ...
    jQuery('.wpbe_post_check').life('click', function (e) {
...
function wpbe_init_profiles() {
    jQuery('#wpbe_load_profile').change(function () {
    ...
    jQuery('#wpbe_new_profile').keydown(function (e) {
        if (e.keyCode == 13) {
