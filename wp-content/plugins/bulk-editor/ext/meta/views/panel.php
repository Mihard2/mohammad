...
global $WPBE;
?>
<h4><?php esc_html_e('Meta Fields', 'bulk-editor') ?> - <a href="https://wp.bulk-editor.com/document/wordpress-posts-meta-fields/" target="_blank" class="button button-primary wpbe-info-btn"><span class="icon-book"></span>&nbsp;<?php esc_html_e('Documentation', 'bulk-editor') ?></a></h4>

<?php if ($WPBE->show_notes) : ?>
<span class="wpbe_set_attention"><?php esc_html_e('In FREE version of the plugin it is possible manipulate with 2 meta fields.', 'bulk-editor') ?></span><br />
<?php endif; ?>
...
function wpbe_meta_print_li($m) {
    ...
    <li class="wpbe_options_li">
        ...
        <div class="col-lg-4">
            <input type="text" name="wpbe_meta_fields[<?php echo $m['meta_key'] ?>][meta_key]" value="<?php echo $m['meta_key'] ?>" readonly="" class="wpbe_column_li_option" />&nbsp;
