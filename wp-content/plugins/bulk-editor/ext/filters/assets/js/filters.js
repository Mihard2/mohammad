...
jQuery(function ($) {
    ...
    jQuery('.wpbe_filter_select').change(function () {
    ...
    jQuery('#wpbe_filter_form input').keydown(function (e) {
        if (e.keyCode == 13) {
    ...
    jQuery("input[name='wpbe_filter_form_tools_value']").unbind().bind('keyup change', function (e) {
        if (e.keyCode === 13) {
