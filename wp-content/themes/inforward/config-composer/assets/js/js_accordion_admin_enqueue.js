...
var Shortcodes = vc.shortcodes;
	...
	window.InforwardVcBackendTtaViewInterface = vc.shortcode_view.extend({
		sortableSelector: !1,
		$sortable: !1,
		$navigation: !1,
		...
		initialize: function(params) {
			window.InforwardVcBackendTtaViewInterface.__super__.initialize.call(this, params), _.bindAll(this, "updateSorting")
		},
		render: function() {
			return window.InforwardVcBackendTtaViewInterface.__super__.render.call(this), this.$el.addClass("vc_tta-container vc_tta-o-non-responsive"), this
		},
		setContent: function() {
		...
		changedContent: function(view) {
			var changedContent;
			return changedContent = window.InforwardVcBackendTtaViewInterface.__super__.changedContent.call(this, view), this.checkForActiveSection(), this.buildSortable(this.$sortable), changedContent
		},
	...
	window.InforwardVcBackendTtaAccordionView = InforwardVcBackendTtaViewInterface.extend({
