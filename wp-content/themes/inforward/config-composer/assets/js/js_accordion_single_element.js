...
var Shortcodes = vc.shortcodes;
	...
	window.InforwardVcBackendTtaSectionView = window.VcColumnView.extend({
		parentObj: null,
		events: {
		...
		render: function() {
			var parentObj;
			return window.InforwardVcBackendTtaSectionView.__super__.render.call(this), parentObj = vc.shortcodes.get(this.model.get("parent_id")), _.isObject(parentObj) && !_.isUndefined(parentObj.view) && (this.parentObj = parentObj), this.$el.addClass("vc_tta-panel"), this.$el.attr("style", ""), this.$el.attr("data-vc-toggle", "tab"), this.replaceTemplateVars(), this
		},
		...
		ready: function() {
			this.updateParentNavigation(), window.InforwardVcBackendTtaSectionView.__super__.ready.call(this)
		},
		...
		changeShortcodeParams: function(model) {
			window.InforwardVcBackendTtaSectionView.__super__.changeShortcodeParams.call(this, model), _.isObject(this.parentObj) && this.parentObj.view && this.parentObj.view.notifySectionChanged && this.parentObj.view.notifySectionChanged(model)
		}
	});
