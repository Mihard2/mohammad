...
if ( $posts ) : ?>
	...
	<div class="widget-events tribe-list-widget">
		<?php
		...
		foreach ( $posts as $post ) :
			...
			?>
			<div class="event-item tribe-events-list-widget-events <?php tribe_events_event_classes() ?>">
				<?php
				if (
	...
	<p class="tribe-events-widget-link">
		<a  class="info-btn" href="<?php echo esc_url( tribe_get_events_link() ); ?>" rel="bookmark"><?php printf( esc_html__( 'View All %s', 'inforward' ), $events_label_plural ); ?></a>
	</p>

<?php
// No events were found.
else : ?>
	<p><?php printf( esc_html__( 'There are no upcoming %s at this time.', 'inforward' ), $events_label_plural_lowercase ); ?></p>
<?php
endif;
