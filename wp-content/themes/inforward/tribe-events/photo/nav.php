...
<ul class="tribe-events-sub-nav">
	...
	<?php if ( tribe_has_previous_event() ) : ?>
		<li class="tribe-events-nav-previous">
			<a href="#" class="tribe_paged"><?php printf( wp_kses(__( '<span>&laquo;</span> Previous %s', 'inforward' ), 'default'), $events_label_plural ); ?></a>
		</li>
	<?php endif; ?>
	<!-- Display Next Page Navigation -->
	<?php if ( tribe_has_next_event() ) : ?>
		<li class="tribe-events-nav-next">
			<a href="#" class="tribe_paged"><?php printf( wp_kses(__( 'Next %s <span>&raquo;</span>', 'inforward' ), 'default'), $events_label_plural ); ?></a>
		</li>
	<?php endif; ?>
</ul>
