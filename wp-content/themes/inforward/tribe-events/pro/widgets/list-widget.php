...
echo '<div class="widget-events">';
	foreach ( $posts as $post ) :
		...
		<!-- Event  -->
		<div class="event-item <?php tribe_events_event_classes() ?>">
	...
	<p class="tribe-events-widget-link">
		<a class="info-btn" href="<?php echo esc_url( $link_to_all ) ?>" rel="bookmark">
			<?php esc_html_e( 'More Events', 'inforward' ) ?>
		</a>
	</p>
...
?>
	<p><?php printf( wp_kses(__( 'There are no upcoming %s at this time.', 'inforward' ), 'default'), tribe_get_event_label_plural_lowercase() ); ?></p>
<?php
endif;
