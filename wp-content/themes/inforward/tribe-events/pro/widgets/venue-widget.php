...
<div class="tribe-venue-widget-wrapper">
	...
	<?php if ( 0 === $events->post_count ): ?>
		<?php printf( wp_kses(__( 'No upcoming %s.', 'inforward' ),'default'), $events_label_plural_lowercase ); ?>
	<?php else: ?>
	...
	<a href="<?php echo esc_url( tribe_get_venue_link( $venue_ID, false ) ); ?>"><?php printf( wp_kses(__( 'View all %1$s at this %2$s', 'inforward' ), 'default'), $events_label_plural, tribe_get_venue_label_singular() ); ?></a>
</div>
