	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<input type="submit" class="woocommerce-Button woocommerce-Button--alt button btn btn-style-6 btn-big alt" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'inforward' ); ?>" />
				<input type="hidden" name="woocommerce_add_payment_method" id="woocommerce_add_payment_method" value="1" />
			</div>
		</div>
	</form>
<?php else : ?>
	<p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e( 'New payment methods can only be added during checkout. Please contact us if you require assistance.', 'inforward' ); ?></p>
<?php endif; ?>
