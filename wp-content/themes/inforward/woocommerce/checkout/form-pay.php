...
<form id="order_review" method="post">
	...
	<table class="shop_table">
		<thead>
			<tr>
				<th class="product-name"><?php _e( 'Product', 'inforward' ); ?></th>
				<th class="product-quantity"><?php _e( 'Qty', 'inforward' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'inforward' ); ?></th>
			</tr>
		</thead>
		<tbody>
